...
with DAG(
        dag_id='news_article_crawling_total_DAG',
    ...
    naver_news_csv_filename = "data/naver_news/news_data_total.csv"
    news_article_csv_filename = "data/news_article/news_article_total.csv"
    ...
    news_article_crawling_s3_to_redshift_task = S3ToRedshiftOperator(
        ...
        s3_bucket = "de-4-3",
        s3_key = news_article_csv_filename,
        schema = "raw_data",
        table = "news_article",
