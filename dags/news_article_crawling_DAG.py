...
with DAG(
    ...
    def get_news_article_crawling_data_from_naver_news(**kwargs):
        ...
        kwargs['ti'].xcom_push(key='news_article_csv_filename', value=news_article_csv_filename)
    ...
    def upload_csv_to_s3(**kwargs):
        ...
        news_article_csv_filename = kwargs['ti'].xcom_pull(task_ids='get_news_article_crawling_csv_task', key='news_article_csv_filename')
        
        s3_hook.load_file(
            filename=news_article_csv_filename, 
            key=news_article_csv_filename,
            bucket_name="de-4-3",
            replace=True
            )
    ...
    get_news_article_crawling_csv_task = PythonOperator(
        task_id='get_news_article_crawling_csv_task',
        python_callable= get_news_article_crawling_data_from_naver_news,
        provide_context=True,
        dag=dag
    )

    upload_news_article_csv_to_s3_task = PythonOperator(
        task_id='upload_news_article_csv_to_s3_task',
    ...
    news_article_crawling_s3_to_redshift_task = S3ToRedshiftOperator(
        ...
        s3_bucket = "de-4-3",
        s3_key = "{{ ti.xcom_pull(task_ids='get_news_article_crawling_csv_task', key='news_article_csv_filename') }}",
        schema = "raw_data",
        table = "news_article",
    ...
    get_news_article_crawling_csv_task >> upload_news_article_csv_to_s3_task >> news_article_crawling_s3_to_redshift_task